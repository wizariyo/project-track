...
const broken = `  if (saved) document.documentElement.setAttribute('data-theme', saved);
  updateThemeBtn();
...
const fixed = `  if (saved) document.documentElement.setAttribute('data-theme', saved);
  updateThemeBtn();
