...
# Ensure you have set the ELEVENLABS_API_KEY environment variable before running this script.
...
SCENES = [
    {
        "filename": "cinematic_vo_scene_1.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_2.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_3.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_4.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_5.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_6.mp3",
    ...
    {
        "filename": "cinematic_vo_scene_7.mp3",
...
for scene in SCENES:
    filepath = f"public/assets/{scene['filename']}"
    print(f"Generating {scene['filename']}...")
    
    try:
        # Generate the audio using a free default voice (Adam)
        audio = elevenlabs.text_to_speech.convert(
            voice_id="pNInz6obpgDQGcFmaJgB", # Adam (Default Free Voice)
            text=scene['text'],
            model_id="eleven_v3",
            language_code="en",
        )
        ...
        print(f"Failed to generate {scene['filename']}: {e}")

print("\nAll ElevenLabs Voiceovers generated! You can find them in the public/assets/ folder.")
